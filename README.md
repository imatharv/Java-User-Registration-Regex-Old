...
## User registration using regular expressions and JUnit
...
The repository contains a java program which comepares the input string or number with the predefined regular expression and returns a boolean value whether it is satisfying that regular expression patter or not. THe whole thing is programmed in eclipse.
